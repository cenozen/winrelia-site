...
export default function Home() {
  return <main>
    <header className="site-header">
      ...
      <nav aria-label="Main navigation"><a href="#services">Solutions</a><a href="#audit">Free SKU audit</a><a href="#why">Why Winrelia</a><a href="#process">How it works</a><a href="#about">About us</a></nav>
    ...
    <section className="closing"><span className="closing-mark">W</span><p className="kicker light">One SKU is enough to begin</p><h2>Find the hidden cost<br/><em>before your next order.</em></h2><p>Send Owen a product link, current package size and target market. We will reply with a practical review of where cost or risk may be reduced.</p><div className="actions"><a className="button white" href="https://wa.me/8613430302527?text=Hi%20Owen%2C%20I%27d%20like%20a%20free%20SKU%20audit.%20Here%20is%20my%20product%20link%3A" target="_blank" rel="noreferrer">WhatsApp Owen <ArrowRight size={18}/></a><a className="email-link" href="mailto:winrelia@hotmail.com?subject=Free%20SKU%20audit">winrelia@hotmail.com</a></div></section>
